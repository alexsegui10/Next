...
const EMBED_URL = CALENDAR_ID
  ? `https://calendar.google.com/calendar/embed?src=${encodeURIComponent(CALENDAR_ID)}&ctz=Europe%2FMadrid&mode=WEEK&showTitle=0&showNav=1&showDate=1&showPrint=0&showTabs=0&showCalendars=0&showTz=0`
  : '';
          ...
          {EMBED_URL ? (
            ...
            >
              ...
              <p className="text-sm text-on-surface-variant max-w-xs leading-relaxed">
                Configura <code className="text-secondary bg-surface-container-high px-1.5 py-0.5 rounded text-xs">VITE_GOOGLE_CALENDAR_ID</code> para mostrar la disponibilidad real.
              </p>
            </div>
          )}
